            ...
            <script>
                $(document).ready(function() {
                    var table = $('#tasks-table').DataTable({
                        ...
                        "columnDefs": [{
                                "orderable": false,
                                "targets": [0] // PENTING: Nonaktifkan sorting untuk kolom No
                            },
                            {
                                "searchable": false,
                            ...
                            {
                                "className": "dt-center",
                                "targets": [0] // Center align untuk kolom No
                            }
                        ],
                        "order": [
                            [1, 'asc']
                        ], // Default sort by Task Title (kolom ke-2)
                        "responsive": true,
                        "drawCallback": function(settings) {
                            // Update nomor urut setiap kali tabel di-redraw (pagination, search, sort)
                            var api = this.api();
                            var rows = api.rows({
                                page: 'current'
                            }).nodes();
                            ...
                            // Loop melalui setiap baris yang terlihat
